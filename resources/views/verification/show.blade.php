        ...
        <div class="glass-effect rounded-3xl overflow-hidden shadow-xl">
            ...
            <div class="p-8 bg-white/50 dark:bg-gray-800/50">
                <form action="/verify/{{ $unique_id }}" method="POST" class="space-y-6">
                    ...
                    <div class="mb-6 has-validation">
                        <label for="otp"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"></label>
                        <div class="relative">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="/register"
                        class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition-colors">Resend
                        OTP</a>
                </p>
            </div>
        </div>
